...
function appendBysrch(data, lat, long) {
  ...
  water_mark.innerText = `Developed by 💕 Akshay Chauhan`;

  document.querySelector(".popltn").classList.add("visible");

  document
    .querySelector(".popltn")
    .append(h2day, hr1, div_lat, div_lon, hr2, water_mark);
  ...
  document
    .querySelector("#detl")
    .append(h5Sky, div_d1, div_d2, div_d3, div_d4, div_d5, div_d6);
